...
public class CountAlphabet {
	...
	public static String replaceChar(String str, char ch, int index) {
		//return from 0 index and replace character at a given index, add all characters excluding replaced one
	    return str.substring(0, index) + ch + str.substring(index+1);// skipping character that needs to be replaced
	}
